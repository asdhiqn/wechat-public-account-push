export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx66a370a5b1b831c6",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "52fb1b2dc5645fb4d72595839973997b",
  ...
  USERS: [
    {
      ...
      id: "olcwm6LMHkrJUe3voPR6ANINnTIk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "vwLb-YIpgZ8nvcctoajLHbYyw_EmE68huUoiUCG1uXc",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "河源",
      ...
      customizedDateList: [
        ...
        // 例假日
        {"keyword": "ex_day", date: "2022-10-21"},
      ]
    },
    {
      name: "老婆1",
  ...
  CALLBACK_TEMPLATE_ID: "vwLb-YIpgZ8nvcctoajLHbYyw_EmE68huUoiUCG1uXc",
  ...
  CUSTOMIZED_DATE_LIST: [
    // 在一起的日子
    {"keyword": "love_day", date: "2021-03-28"},
    // 结婚纪念日
    {"keyword": "marry_day", date: "2023-01-01"},
    // 退伍日
    {"keyword": "ex_day", date: "2023-02-16"},
    // 你可以不断按格式往下增加
    // ...
  ],
